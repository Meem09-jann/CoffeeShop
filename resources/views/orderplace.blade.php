                    ...
                    <table class="timetable_sub">
                        ...
                        @foreach ($products as $item)
							<tr class="rem1">
								...
								<td class="invert">{{$item['price']}} Taka</td>
								<td class="invert">
									<div class="rem">
				    ...
				    <form action="cnfmOrder" method="post">
						<div class="col-md-4 checkout-left-basket">
							...
							<ul>
								...
								<li name="item">{{$item['name']}} <i>-</i> <span>{{$item['price']}} Taka </span></li>
								<input class="billing-address-name form-control" type="hidden" name="qty"  value="{{$item['qty']}}">
								@endforeach
								
								<li style="border-bottom: 1px solid #DDD; margin: 2em 0 0;">Item Price<i>-</i> <span>{{$totalPrice}}.00 Taka</span></li>
								...
								<li style=" margin: 2em 0 0">Service Charges <i>-</i> <span name="charge">{{$charge}}.00 Taka</span></li>
								...
								<label  style="color: #af0be4">Apply Voucher </label>
												<select class="form-control option-w3ls" style="padding: 0 5px">
													<option>Morning 50/= </option> <span>50.00 Taka </span>
													<option>Evening 20/=</option> <span>20.00 Taka </span>
									...
									<div class="information-wrapper">
										<div class="first-row form-group">
											<div class="controls">
												...
												<input class="billing-address-name form-control" type="text" name="DelName" placeholder="Full name" value="{{$item->cName}}"required="">
											...
											<div class="card_number_grids">
												<div class="card_number_grid_left">
													<div class="controls">
														...
														<input class="form-control" name="DelPhone" type="text" value="{{$item->cPhone}}" required="">
													</div>
												</div>
